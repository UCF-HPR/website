                ...
                if (!YTPlayer.isBackground) {
                    overlay
                        .on('mouseenter', function() {
                            if (YTPlayer.controlBar.length) YTPlayer.controlBar.addClass('visible');
                        })
                        .on('mouseleave', function() {
                            if (YTPlayer.controlBar.length) YTPlayer.controlBar.removeClass('visible');
                        });
                }
...
(jQuery.support.CSStransition = (function() {
    ...
    (jQuery.CSS = {
        ...
        normalizeCss: function(e) {
            ...
            for (var r in t) {
                'transform' === r && ((t[jQuery.CSS.sfx + 'transform'] = t[r]), delete t[r]),
                    'transform-origin' === r && ((t[jQuery.CSS.sfx + 'transform-origin'] = e[r]), delete t[r]),
                    'filter' !== r || jQuery.browser.mozilla || ((t[jQuery.CSS.sfx + 'filter'] = e[r]), delete t[r]),
            ...
            return this.each(function() {
                ...
                if (((u.CSSqueue = null), (u.eventType = o.type), 0 !== a.length && e)) {
                    if (
                        ...
                        (u.CSSAIsRunning = !0),
                        'function' == typeof t && ((n = t), (t = jQuery.fx.speeds._default)),
                        'function' == typeof r && ((i = r), (r = 0)),
                        'string' == typeof r && ((n = r), (r = 0)),
                        'function' == typeof i && ((n = i), (i = 'cubic-bezier(0.65,0.03,0.36,0.72)')),
                        'string' == typeof t)
                    )
                        ...
                        (u.timeout = setTimeout(function() {
                            return u.called || !n
                                ...
                                : (a.css(jQuery.CSS.sfx + 'transition', ''),
                                  n.apply(u),
                                  (u.CSSAIsRunning = !1),
                                  void ('function' == typeof u.CSSqueue && (u.CSSqueue(), (u.CSSqueue = null))));
                        }, t + r + 10));
                }
            });
        },
